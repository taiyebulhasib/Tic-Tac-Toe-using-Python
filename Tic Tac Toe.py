...
pg.display.set_caption('Tic Tac Toe by T.Hasib')
...
def draw_status():
    ...
    # creating a small block a the bottom of the main display
...
def check_win():
    ...
    if board[0][2] == board[1][1] == board[2][0] and (board[0][2] is not None):
        # game won diagonally right t lft
        winner = board[0][2]
